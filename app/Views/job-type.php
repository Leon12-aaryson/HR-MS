...
<main>
            <div class="container">
                <h1 class="title">Manage Job Types</h1>
                <ul class=" emp" style="line-height: none;">
                    <li><a href="#">Home</a></li>
                    <li class="divider">/</li>
                    <li><a href="#" class="active">Job Types</a></li>
                    <li><a href="#"  class="btn btn-sm" style="background: var(--skin-color); color: #fff" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Add Job Type</a></li>
                </ul> 
                <div class="hr"></div>
               ...
               <div class="setup">
                <div class="list mt-3">
                    <ul>
                        ...
                        <i class='bx bxs-chevron-right arrow'></i></li>
                        <li class="active-list"><a href="#">Job Type</a>
                        <i class='bx bxs-chevron-right arrow'></i></li>
                    </ul>
                </div>
                <div>
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-header">
                <h2 class="modal-title fs-5 text-primary" id="staticBackdropLabel">Add Job type</h2>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form>
                    <div class="mb-3">
                      <label for="exampleInput1" class="form-label text-primary">Job Type</label>
