                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                        <div class="row g-0 about-bg rounded overflow-hidden">
                            <div class="col-6 text-start">
                                <img class="img-fluid w-100" src="./public/img/about-1.jpg">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid" src="./public/img/about-2.jpg" style="width: 85%; margin-top: 15%;">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid" src="./public/img/about-3.jpg" style="width: 85%;">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid w-100" src="./public/img/about-4.jpg">
                            </div>
                        </div>
                    </div>
                ...
                <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <div class="tab-content">
                        ...
                        <div id="tab-2" class="tab-pane fade show p-0  active">
                            <?php if ($full_vacancies) : ?>
                                <?php foreach ($full_vacancies as $vacancy) : ?>
                                    <div class="job-item p-4 mb-4">
                                        <div class="row g-4">
                                            <div class="col-sm-12 col-md-8 d-flex align-items-center">
                                                <img class="flex-shrink-0 img-fluid border rounded" src="./public/img/com-logo-1.jpg" alt="" style="width: 80px; height: 80px;">
                                                <div class="text-start ps-4">
                                                    <h5 class="mb-3"><?= esc($vacancy['position']) ?></h5>
                                                    <span class="text-truncate me-3"><i class="fa fa-map-marker text-primary me-2"></i><?= esc($vacancy['address']) ?></span>
                                                    <span class="text-truncate me-3"><i class="far fa-clock text-primary me-2"></i><?= esc($vacancy['job_nature']) ?></span>
                                                    <span class="text-truncate me-0"><i class="far fa-money-bill-alt text-primary me-2"></i><?= esc($vacancy['salary']) ?></span>
                                                </div>
                                            </div>
                                            <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                                <div class="d-flex mb-3">
                                                <a class="btn btn-primary" href="<?= base_url('job-detail/' . $vacancy['vacancy_id']); ?>">Apply Now</a>

                                                </div>
                                                <small class="text-truncate"><i class="far fa-calendar-alt text-primary me-2"></i> <?= esc($vacancy['deadline_date']) ?></small>
                                            </div>
                                        </div>
                                    </div>
                                <?php endforeach; ?>
                            <?php else : ?>
                                <p>No full-time vacancies available</p>
                            <?php endif; ?>

                        </div>
                        <div id="tab-3" class="tab-pane fade show p-0">
                            <?php if ($part_vacancies) : ?>
                                <?php foreach ($part_vacancies as $vacancy) : ?>
                                    <div class="job-item p-4 mb-4">
                                        <div class="row g-4">
                                            <div class="col-sm-12 col-md-8 d-flex align-items-center">
                                                <img class="flex-shrink-0 img-fluid border rounded" src="./public/img/com-logo-1.jpg" alt="" style="width: 80px; height: 80px;">
                                            ...
                                            <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                                <div class="d-flex mb-3">
                                                    ...
                                                    <a class="btn btn-primary" href="<?= base_url('job-detail'); ?>">Apply Now</a>
                                                </div>
                                                <small class="text-truncate"><i class="far fa-calendar-alt text-primary me-2"></i> <?= esc($vacancy['deadline_date']) ?></small>
                                            </div>
                                        </div>
                                ...
                                <?php endforeach; ?>
                            <?php else : ?>
                                <p>No part-time vacancies available</p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
